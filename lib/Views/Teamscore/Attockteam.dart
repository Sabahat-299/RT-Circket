...
class AttockTeam extends StatefulWidget {
  const AttockTeam({Key? key, required String title}) : super(key: key);

  @override
  State<AttockTeam> createState() => _AttockTeamState();
}

class _AttockTeamState extends State<AttockTeam> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Container(height: 11,),
        TextWidget(title: 'YET TO BAT:Kaif - Kashif - Kinhan',fontSize: 12,color: Colors.white,),
        Container(height: 11,),
        ListView.separated(
          shrinkWrap: true,
